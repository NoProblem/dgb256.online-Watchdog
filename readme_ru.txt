...
5. Запустить скрипт (двойной клик на файле dgb256_watchdog.ahk), в трее появится иконка "пауза" нужно кликнуть по ней правой кнопкой и выбрать в списке "Run dgb256 Watch Dog"
6. Профит!
