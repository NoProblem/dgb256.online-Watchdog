Скрипт для мониторинга состояния асиков на пуле dgb256.online. Скрипт бесплатный с откртым кодом пользуйтесь на здоровье :)
...
4. Скачать и распаковать скрипт https://github.com/NoProblem/dgb256.online-Watchdog/raw/master/dgb256.online-Watchdog.zip
5. Прописать в файле dgb256_watchdog.ini ваши настройки:
...
6. Запустить скрипт (двойной клик на файле dgb256_watchdog.ahk), в трее появится иконка "пауза" нужно кликнуть по ней правой кнопкой и выбрать в списке "Run dgb256 Watchdog"
7. Профит!
